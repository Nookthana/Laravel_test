                ...
                <div class="container">
                    <div class="row">
                      <div class="col-sm">
                        ...
                        @foreach($galleryAll->chunk(3) as $chunk)
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form method="POST" action="{{ route('EditImageOnCategory') }}" id="form_image_edit" 
                                enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="image">
                              <input type="hidden" id="categoryID" name="categoryID" class="form-control" value="{{ $categoryID }}"/>
                              <input type="file" id="photo_edit_on_category" name="photo_edit_on_category" class="form-control" required name="image">
...
<br/>
  ...
  <script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
    ...
    $("#photo_edit_on_category").change(function () {
